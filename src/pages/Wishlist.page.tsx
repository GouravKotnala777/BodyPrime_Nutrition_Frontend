...
function Wishlist() {
    ...
    if (wishlistData.length === 0) return(
        <div className="text-center pt-10 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-500 mt-0 mb-10">seems like you have not liked anything yet.</p>
            <div className="text-center my-8">
                <button className="bg-primary-100 hover:bg-primary-50 text-primary-500 font-semibold w-full max-w-50 mx-auto pt-2.75 pb-2.75 rounded-md flex justify-center items-center gap-1 transition-colors ease-out duration-300 group"
    ...
    return(
        <section className="p-4">
            <div className="flex flex-col sm:flex-row gap-4 relative">
                    ...
                    <div>
                        ...
                        <div className="text-gray-400 text-lg font-semibold">Shopping Cart</div>
                        {
                            wishlistData.length === 0 ?
                                <div>
                                    <img src="/empty_cart.jpg" alt="/empty_cart.jpg" className="w-full max-w-110 mx-auto" />
                                    <div className="text-center">
                                        <button className="bg-orange-100 hover:bg-orange-50 text-orange-800 font-semibold w-full max-w-70 mx-auto py-2.5 rounded-md flex justify-center items-center gap-1 transition-colors ease-out duration-300 group"
                                            onClick={() => navigate("/home")}
                                        >
                ...
                {/* right part */}
                <div id="price_details" className="border border-gray-200 min-w-100 h-min rounded-xl sticky top-21 right-0 p-4">{/*give mb-15 sm:mb-0*/}
                    {
                        wishlistData.length === 0 ?

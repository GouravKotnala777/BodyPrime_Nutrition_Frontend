...
const dummyReview:ReviewTypesPopulated[] = [
    ...
    {productID:{name:"product1", size:1, weight:"2kg", flavor:"milk creame"}, userID:{name:"Naruto Uzumaki"}, rating:1.8, comment:"In ex dolore mollitia adipisci ut officia ab praesentium voluptatem ratione ipsa?", createdAt:"22-07-2004", updatedAt:""},

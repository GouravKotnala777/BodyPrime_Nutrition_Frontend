...
function Footer() {
    ...
    return(
        <div className="w-full h-80 bg-primary relative overflow-hidden z-0">
            {/* arc stripe */}
            <div className="w-full h-[50%] rounded-b-[100%] absolute -top-20 left-0 bg-white"></div>

            {/* footer links */}
            <div className="h-full bg-primary-400">
                <div className="content-center border h-full px-10">
                    <div className="border-b flex justify-between items-center mt-25 text-white">

                        {/* navigations */}
                        <div className="flex gap-10 text-lg">
                            <div className="group">
                                <NavLink to="####">Product</NavLink>
                                <div className="w-0 h-0.5 bg-white group-hover:w-full transition-all ease-in-out duration-300"></div>
                            </div>
                            <div className="group">
                        ...
                        {/* logo */}
                        <NavLink to="/home" className=""><img src="logo.png" alt="logo.png" className="w-25 h-25" /></NavLink>
                        ...
                        <div className="flex gap-10">
                            ...
                            <NavLink to="https://www.facebook.com/1160849520434919/" className="rounded-full w-10 h-10 grid place-items-center relative overflow-hidden group">
                                <div className="w-full h-full bg-white scale-y-0 group-hover:scale-y-100 transition-transform origin-top ease-in-out duration-300"></div>
                                <div className="border border-primary-400 absolute top-[50%] left-[50%] -translate-[50%] w-[90%] h-[90%] rounded-full bg-primary-50 grid place-items-center">
                                    {/*<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="size-6 fill-primary-400"><path d="M224,40V216a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8H216A8,8,0,0,1,224,40Z" opacity="0.2"></path><path d="M216,24H40A16,16,0,0,0,24,40V216a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V40A16,16,0,0,0,216,24Zm0,192H40V40H216V216ZM96,112v64a8,8,0,0,1-16,0V112a8,8,0,0,1,16,0Zm88,28v36a8,8,0,0,1-16,0V140a20,20,0,0,0-40,0v36a8,8,0,0,1-16,0V112a8,8,0,0,1,15.79-1.78A36,36,0,0,1,184,140ZM100,84A12,12,0,1,1,88,72,12,12,0,0,1,100,84Z"></path></svg>*/}
                                </div>
                            </NavLink>
                        </div>
                    </div>
                    <div className="my-5 text-white/80 font-sm">Copyright 2026. BodyPrime Nutrition - All Rights Reserved.</div>

        ...
        <div className="w-full h-90 bg-primary relative overflow-hidden z-0">
            ...
            <div className="h-full bg-primary-400">
                <div className="content-center h-full px-4 sm:px-10">
                    ...
                    <div className="my-5 text-white/70 text-xs">Copyright 2026. BodyPrime Nutrition - All Rights Reserved.</div>
                    <div className="">
                        <div className="flex justify-center items-center text-sm w-max mx-auto p-2 group">
                            <div className="text-white/70">made with</div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="fill-primary-200 text-white/70 p-1 animate-bounce  group-hover:fill-white transition-color ease-out duration-300">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                            </svg>
                            <div className="text-white/70 translate-x-0.25">by</div>
                            <NavLink to="https://github.com/GouravKotnala777" target="_blank" className="text-white/70 translate-x-1.75 underline underline-white underline-offset-4 group-hover:text-white transition-color ease-out duration-300">gourav kotnala</NavLink>
                        </div>
                    </div>
